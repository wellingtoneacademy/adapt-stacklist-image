define(function(require) {
    ...
    var StackListImage = ComponentView.extend({

        TRANSITION_TIME: 250,

        events: {
            "click .stacklistimage-next": "nextItem"
        },
        ...
        postRender: function() {
            this.$items = this.$(".stacklistimage-item");
            this.$button = this.$('.stacklistimage-button');
        ...
        setupButton: function() {
            ...
            var btnAriaLabel = this.model.get("_globals")._components._stacklistimage.ariaButtonLabel || this.model.get("_globals")._accessibility._ariaLabels.next;
        ...
        setStage: function(stage) {
            ...
            var $item = this.$(".stacklistimage-item").eq(stage);
        ...
        onComplete: function() {
            var $buttonDiv = this.$(".stacklistimage-button");
            var $button = this.$(".stacklistimage-next");
    ...
    Adapt.register('stacklistimage', StackList);
